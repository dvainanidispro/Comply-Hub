...
window.dimtables.defaultOptions = {
    ...
    showTopBar: true, // εμφάνιση μπάρας με αναζήτηση & pager
...
(function () {
  ...
  // Μετατροπή ελληνικής ημερομηνίας (dd/mm/yyyy ή dd/mm/yyyy, hh:mm) σε timestamp.
  // Διαχωριστικό ημερομηνίας/ώρας είναι το κενό — ό,τι υπάρχει ανάμεσα (κόμμα, παύλα κλπ.) αγνοείται.
