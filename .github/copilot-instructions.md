...
- Αποθήκευση των αρχείων στον τοπικό δίσκο μέσα στο φάκελο `storage/`. H διαχείριση των αρχείων γίνεται μέσω του utility `Storage` από το `utils/storage.js`. To utility φροντίζει για την σωστή αποθήκευση ελληνικών ονομάτων (σε utf8).
