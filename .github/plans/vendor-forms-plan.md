...
Ο οργανισμός βλέπει όλα τα responses των δικών του partners από το authenticated περιβάλλον του, χωρίς να χρησιμοποιεί public links. Το `Response` παραμένει το μοναδικό σημείο αλήθειας για την κατάσταση της πρόσκλησης, τις απαντήσεις, το snapshot και το audit trail.
...
Σκοπός: ο οργανισμός να μπορεί να επιλέγει έναν ενεργό partner και ένα κατάλληλο questionnaire και να δημιουργεί μια συγκεκριμένη "πρόσκληση συμπλήρωσης".
...
Σκοπός: ο οργανισμός να έχει authenticated λίστα και detail view για όλες τις αναθέσεις questionnaires προς partners.

Επιθυμητό αποτέλεσμα: ο οργανισμός βλέπει partner, questionnaire, κατάσταση, ημερομηνίες, πρόοδο και τελική απάντηση, χωρίς να χρησιμοποιεί public links και χωρίς διαρροή δεδομένων μεταξύ οργανισμών.
...
Επιθυμητό αποτέλεσμα: οι εξωτερικές προσκλήσεις διαχειρίζονται από καθαρή operational επιφάνεια χωρίς να χάνεται το ιστορικό των responses.
