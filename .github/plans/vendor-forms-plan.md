...
### 1. Καθορισμός της ανάθεσης questionnaire σε partner και Δημιουργία invitation credentials - Done!
...
### 6. Σχεδιασμός ανάκαμψης από ληγμένο public session - Done!
...
### 2. Ανάκληση του token

Προς το παρόν δεν υπάρχει ξεχωριστή λειτουργία "ανάκλησης" του access token (π.χ. μηδενισμός του `accessTokenHash` χωρίς νέο token). Η ανάκληση της πρόσβασης καλύπτεται έμμεσα δημιουργώντας νέο token χωρίς να το κοινοποιήσουμε στον partner, οπότε το παλιό token παύει να λειτουργεί. Αν χρειαστεί στο μέλλον ρητή λειτουργία ανάκλησης (χωρίς έκδοση νέου token), θα προστεθεί ως ξεχωριστό βήμα.
