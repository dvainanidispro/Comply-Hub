 ...
 *     Περιλαμβάνει και τα `actions` (κουμπιά της φόρμας: save/submit κ.λπ.) —
 ...
 * όποια keys χρειάζεται η φόρμα, και επιπλέον των path/text/color.
 */
...
class Questionnaire {
  /**
   * @param {object} def  { code, title, description?, actions?, sections: [] }
   ...
   *   φόρμας. Αν λείπει, ισχύει ΟΛΟΚΛΗΡΟ το DEFAULT_ACTIONS (save + submit).
  ...
  constructor(def, opts = {}) {
    ...
    this.sections = (def.sections || []).map((s) => new Section(s, this.templates));
