 ...
 * shared.js
 * --------------------------------------------------------------------------
 * Δήλωση αρχείων που χρησιμοποιούνται και στο front-end και στο back-end, ώστε να
 * σερβίρονται ως static αρχεία χωρίς να χρειάζεται αντιγραφή τους στο public/.
 * --------------------------------------------------------------------------
